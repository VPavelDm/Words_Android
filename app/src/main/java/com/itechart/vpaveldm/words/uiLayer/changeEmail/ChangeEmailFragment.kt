package com.itechart.vpaveldm.words.uiLayer.changeEmail
...
import com.itechart.vpaveldm.words.databinding.FragmentChangeEmailBinding

class ChangeEmailFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val binding = FragmentChangeEmailBinding.inflate(inflater, container, false)
